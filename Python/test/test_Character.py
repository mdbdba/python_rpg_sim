...
#    compArray = [15, 14, 13, 12, 10, 8]
    ...
    assert(a1)
    tmp_array = a1.getRawAbilityArray()
    for i in range(0, 6):
        if tmp_array[i] == 15:
            found15 = True
        elif tmp_array[i] == 14:
...
def test_RandomGen_Retrieve():
    ...
    assert(compareArrays(a1.getRawAbilityArray(), b1.getRawAbilityArray()))
    assert(compareArrays(a1.getAbilityArray(), b1.getAbilityArray()))
