...
@click.command()
@click.option('-c', '--character_id_str', default=None,
              help='Use if you already have characters and just want them in a party.')
@click.option('-p', '--party_composition_id', default='11', show_default=True,
              help='Defines the classes in the party')
